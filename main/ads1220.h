...
esp_err_t ads1220_select_input(
    ads1220_input_t input
);
...
//#define ADS1220_REG3_DEDICATED_DRDY 0x00U
esp_err_t ads1220_read_input(
    ads1220_input_t input,
    int32_t *conversion_value,
    uint32_t timeout_ms
);
esp_err_t ads1220_read_average(
    ads1220_input_t input,
...
double ads1220_raw_to_microvolts(
    int32_t raw_value
);
...
esp_err_t ads1220_read_register(
    uint8_t register_address,
    uint8_t *register_value
);

esp_err_t ads1220_write_register(
    uint8_t register_address,
    uint8_t register_value
);

esp_err_t ads1220_configure(
    const uint8_t register_values[4]
);